...
Elm.AppStyles = Elm.AppStyles || {};
Elm.AppStyles.make = function (_elm) {
   "use strict";
   _elm.AppStyles = _elm.AppStyles || {};
   if (_elm.AppStyles.values) return _elm.AppStyles.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var plusButton = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: "rgba(96,96,96, 0.8)"}
                                                   ,{ctor: "_Tuple2",_0: "color",_1: "white"}
                                                   ,{ctor: "_Tuple2",_0: "padding",_1: "11px 16px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-top",_1: "8px"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "24px"}
                                                   ,{ctor: "_Tuple2",_0: "border-radius",_1: "50%"}]));
   var selectStyles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "box-shadow",_1: "0px 2px 5px #BABABA"}
                                                     ,{ctor: "_Tuple2",_0: "padding",_1: "12px"}
                                                     ,{ctor: "_Tuple2",_0: "background",_1: "white"}
                                                     ,{ctor: "_Tuple2",_0: "font-size",_1: "16px"}]));
   var taskControls = function (show) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                            ,{ctor: "_Tuple2",_0: "z-index",_1: "1"}
                                            ,{ctor: "_Tuple2",_0: "background",_1: "white"}
                                            ,{ctor: "_Tuple2",_0: "padding",_1: "0px 8px"}
                                            ,show ? {ctor: "_Tuple2",_0: "display",_1: "block"} : {ctor: "_Tuple2",_0: "display",_1: "none"}]));
   };
   var taskRow = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding",_1: "24px"}
                                                ,{ctor: "_Tuple2",_0: "border-bottom",_1: "1px solid #BABABA"}
                                                ,{ctor: "_Tuple2",_0: "display",_1: "flex"}
                                                ,{ctor: "_Tuple2",_0: "justify-content",_1: "space-between"}
                                                ,{ctor: "_Tuple2",_0: "font-size",_1: "24px"}
                                                ,{ctor: "_Tuple2",_0: "position",_1: "relative"}]));
   var hide = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "none"}]));
   var show = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "block"}]));
   var applyDisplayFiler = F2(function (filter,task) {    return _U.eq(filter,task.stage) || _U.eq(filter,"all") ? show : hide;});
   return _elm.AppStyles.values = {_op: _op
                                  ,show: show
                                  ,hide: hide
                                  ,taskRow: taskRow
                                  ...
                                  ,applyDisplayFiler: applyDisplayFiler};
};
...
Elm.DynamicStyle.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var cssStateEffect = F4(function (jsEventInactives,jsEventActive,baseState,hoverState) {
      var jsName = function (cssAttr) {
         return function (s) {
            return A2($Basics._op["++"],$String.toLower(A2($String.left,1,s)),A2($String.dropLeft,1,s));
         }(A2($String.join,
         "",
         A2($List.map,
         function (s) {
            return A2($Basics._op["++"],$String.toUpper(A2($String.left,1,s)),A2($String.dropLeft,1,s));
         },
      ...
      var toJS = function (attrs) {
         ...
         F2(function (_p0,x) {
            ...
            x,
            A2($Basics._op["++"],"this.style.",A2($Basics._op["++"],jsName(_p1._0),A2($Basics._op["++"],"=\'",A2($Basics._op["++"],_p1._1,"\';")))));
         }),
         "",
         attrs);
      };
      ...
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
              baseState,
              A2($List.map,function (_p2) {    var _p3 = _p2;return {ctor: "_Tuple2",_0: _p3._0,_1: _p3._1};},hoverState)))
              ,A2($Html$Attributes.attribute,
              jsEventActive,
              toJS(A2($List.map,function (_p4) {    var _p5 = _p4;return {ctor: "_Tuple2",_0: _p5._0,_1: _p5._2};},hoverState)))]),
      A2($List.map,
      function (inactive) {
         return A2($Html$Attributes.attribute,
         inactive,
         toJS(A2($List.map,function (_p6) {    var _p7 = _p6;return {ctor: "_Tuple2",_0: _p7._0,_1: _p7._1};},hoverState)));
      },
      jsEventInactives));
   });
   var focus$ = A2(cssStateEffect,_U.list(["onblur"]),"onfocus");
   var focus = focus$(_U.list([]));
   var pressure$ = A2(cssStateEffect,_U.list(["onmouseup","onmouseout"]),"onmousedown");
   var pressure = pressure$(_U.list([]));
   var hover$ = A2(cssStateEffect,_U.list(["onmouseout"]),"onmouseover");
...
Elm.Timer.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Increment": return model.isRunning ? {ctor: "_Tuple2",_0: _U.update(model,{seconds: model.seconds + 1}),_1: $Effects.none} : {ctor: "_Tuple2"
                                                                                                                                          ,_0: model
                                                                                                                                          ,_1: $Effects.none};
         case "PauseResume": return {ctor: "_Tuple2",_0: _U.update(model,{isRunning: $Basics.not(model.isRunning)}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: _U.update(model,{seconds: 0}),_1: $Effects.none};}
   });
   var init = {seconds: 0,isRunning: false};
   var Reset = {ctor: "Reset"};
   var PauseResume = {ctor: "PauseResume"};
   var view = F2(function (address,model) {
      var second = A2($Basics._op["%"],model.seconds,60);
      var minute = $Basics.toString(model.seconds / 60 | 0);
      var time = A2($Basics._op["++"],
      minute,
      A2($Basics._op["++"],": ",_U.cmp(second,10) < 0 ? A2($Basics._op["++"],"0",$Basics.toString(second)) : $Basics.toString(second)));
      return A2($Html.div,
      _U.list([]),
      _U.list([$Html.text(time)
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,PauseResume)]),_U.list([$Html.text(model.isRunning ? "pause" : "resume")]))
...
Elm.Todo.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $AppStyles = Elm.AppStyles.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var incrementWatch = function (task) {
      var _p0 = task;
      var timer = _p0.timer;
      return timer.isRunning ? _U.update(task,{timer: {seconds: timer.seconds + 1,isRunning: true}}) : task;
   };
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "AddTask": return {ctor: "_Tuple2"
                              ,_0: _U.update(model,
                              {tasks: A2($Basics._op["++"],
                              model.tasks,
                              _U.list([{description: model.field
                                       ,timer: $Timer.init
                                       ,id: model.nextId
                                       ,stage: "todo"
                                       ,showControls: false
                              ...
                              ,showTaskInput: false})
                              ,_1: $Effects.none};
         case "UpdateField": return {ctor: "_Tuple2",_0: _U.update(model,{field: _p1._0}),_1: $Effects.none};
         case "Tick": var incrementedTasks = A2($List.map,incrementWatch,model.tasks);
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: incrementedTasks}),_1: $Effects.none};
         case "PauseResume": var updateTaskTimer = function (taskModel) {
              if (_U.eq(taskModel.id,_p1._0)) {
                    var _p2 = taskModel;
                    var timer = _p2.timer;
                    return _U.update(taskModel,{timer: _U.update(timer,{isRunning: $Basics.not(timer.isRunning)})});
                 } else return taskModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: A2($List.map,updateTaskTimer,model.tasks)}),_1: $Effects.none};
         case "Reset": var resetTaskTimer = function (taskModel) {
              if (_U.eq(taskModel.id,_p1._0)) {
                    var _p3 = taskModel;
                    var timer = _p3.timer;
                    return _U.update(taskModel,{timer: _U.update(timer,{seconds: 0})});
                 } else return taskModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: A2($List.map,resetTaskTimer,model.tasks)}),_1: $Effects.none};
         case "ChangeStage": var switchStage = function (taskModel) {    return _U.eq(taskModel.id,_p1._1) ? _U.update(taskModel,{stage: _p1._0}) : taskModel;};
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: A2($List.map,switchStage,model.tasks)}),_1: $Effects.none};
         case "ApplyTaskFilter": return {ctor: "_Tuple2",_0: _U.update(model,{filter: _p1._0}),_1: $Effects.none};
         case "ExposeControls": var toggleControls = function (taskModel) {
              return _U.eq(taskModel.id,_p1._0) && _U.eq(taskModel.showControls,false) ? _U.update(taskModel,{showControls: true}) : _U.update(taskModel,
              {showControls: false});
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: A2($List.map,toggleControls,model.tasks)}),_1: $Effects.none};
         case "ToggleStageSelection": var toggleStageSelection = function (taskModel) {
              return _U.eq(taskModel.id,_p1._0) ? _U.update(taskModel,{showStageOptions: $Basics.not(taskModel.showStageOptions)}) : taskModel;
           };
           return {ctor: "_Tuple2",_0: _U.update(model,{tasks: A2($List.map,toggleStageSelection,model.tasks)}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: _U.update(model,{showTaskInput: true}),_1: $Effects.none};}
   });
   var ShowInputField = {ctor: "ShowInputField"};
   var ToggleStageSelection = function (a) {    return {ctor: "ToggleStageSelection",_0: a};};
   var ExposeControls = function (a) {    return {ctor: "ExposeControls",_0: a};};
   var ApplyTaskFilter = function (a) {    return {ctor: "ApplyTaskFilter",_0: a};};
   var applyTaskFilter = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"},{ctor: "_Tuple2",_0: "justify-content",_1: "space-between"}]))]),
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,ApplyTaskFilter("all"))]),_U.list([$Html.text("ALL")]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,ApplyTaskFilter("todo"))]),_U.list([$Html.text("TO-DO")]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,ApplyTaskFilter("inProgress"))]),_U.list([$Html.text("IN PROGRESS")]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,ApplyTaskFilter("completed"))]),_U.list([$Html.text("COMPLETED")]))
              ,A2($Html.span,
              _U.list([]),
              _U.list([A2($Html.button,_U.list([$AppStyles.plusButton,A2($Html$Events.onClick,address,ShowInputField)]),_U.list([$Html.text("+")]))]))]));
   };
   var ChangeStage = F2(function (a,b) {    return {ctor: "ChangeStage",_0: a,_1: b};});
   var PauseResume = function (a) {    return {ctor: "PauseResume",_0: a};};
   ...
   var taskInputField = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.id("new-todo")
              ...
              ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (v) {    return A2($Signal.message,address,UpdateField(v));})
              ,A2(onEnter,address,AddTask)
              ,$AppStyles.taskRow]),
      _U.list([]));
   });
   var changeTaskStage = F2(function (address,task) {
      return A3($Html$Events.on,"click",$Html$Events.targetValue,function (v) {    return A2($Signal.message,address,A2(ChangeStage,v,task.id));});
   });
   var selectList = F2(function (address,task) {
      return A2($Html.div,
      _U.list([A2(changeTaskStage,address,task),$AppStyles.selectStyles]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.value("todo")]),_U.list([$Html.text("todo")]))
              ,A2($Html.div,_U.list([$Html$Attributes.value("inProgress")]),_U.list([$Html.text("in progress")]))
              ,A2($Html.div,_U.list([$Html$Attributes.value("completed")]),_U.list([$Html.text("completed")]))]));
   });
   var taskController = F2(function (address,task) {
      return A2($Html.div,
      _U.list([A2($Html$Events.onClick,address,ToggleStageSelection(task.id)),$Html$Attributes.$class("controls"),$AppStyles.taskControls(task.showControls)]),
      _U.list([$Html.text("")
              ,A2($Html.div,_U.list([]),_U.list([task.showStageOptions ? A2(selectList,address,task) : A2($Html.div,_U.list([]),_U.list([]))]))]));
   });
   var timerView = F2(function (address,task) {
      var _p5 = task;
      var timer = _p5.timer;
      var minute = $Basics.toString(timer.seconds / 60 | 0);
      var second = A2($Basics._op["%"],timer.seconds,60);
      var time = A2($Basics._op["++"],
      minute,
      A2($Basics._op["++"],": ",_U.cmp(second,10) < 0 ? A2($Basics._op["++"],"0",$Basics.toString(second)) : $Basics.toString(second)));
      return A2($Html.span,
      ...
      _U.list([A2($Html.span,
              _U.list([A2($Html$Events.onClick,address,PauseResume(task.id))
                      ,timer.isRunning ? $Html$Attributes.$class("icon-pause") : $Html$Attributes.$class("icon-play")]),
              _U.list([]))
              ,$Html.text(time)]));
   });
   var taskEntry = F3(function (address,filter,task) {
      return A2($Html.div,
      _U.list([A2($AppStyles.applyDisplayFiler,filter,task)
              ,A2($Html$Events.onMouseOver,address,ExposeControls(task.id))
              ,A2($Html$Events.onMouseOut,address,ExposeControls(task.id))]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class(task.stage),$AppStyles.taskRow]),
      _U.list([A2(taskController,address,task),$Html.text(task.description),A2(timerView,address,task)]))]));
   });
   var taskList = F2(function (address,model) {
      var someTasks = A2($List.map,A2(taskEntry,address,model.filter),model.tasks);
      return A2($Html.div,_U.list([]),someTasks);
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding",_1: "24px"}]))]),
      _U.list([applyTaskFilter(address),model.showTaskInput ? A2(taskInputField,address,model) : $Html.text(""),A2(taskList,address,model)]));
   });
   var model = {tasks: _U.list([]),field: "",nextId: 0,filter: "all",showTaskInput: true};
   var Task = F6(function (a,b,c,d,e,f) {    return {description: a,timer: b,id: c,stage: d,showControls: e,showStageOptions: f};});
   var Model = F5(function (a,b,c,d,e) {    return {tasks: a,field: b,nextId: c,filter: d,showTaskInput: e};});
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: model,_1: $Effects.none}
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([A2($Signal.map,function (_p6) {    return Tick;},$Time.every($Time.second))])});
   var main = app.html;
